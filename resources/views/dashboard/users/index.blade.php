                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if(auth()->user()->hasPermission('users_update'))
                                    <a href="{{asset(route('dashboard.users.edit',$user->id))}}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> @lang('site.edit') </a>
                                ...
                                @if(auth()->user()->hasPermission('users_delete'))
                                        ...
                                        <form action="{{asset(route('dashboard.users.destroy',$user->id))}}" method="POST" style="display:inline-block">
                                            @csrf
                                            @method('DELETE')

                                            <button type="submit" class="btn btn-danger btn-sm" id="delete"><i class="fa fa-trash"></i> @lang('site.delete')</button>
                                        </form>
                                    @else
